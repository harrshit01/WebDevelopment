  ...
  return (
    <Stack direction={['column', 'row']}>
        <VStack w={'full'}>
            ...
            src={videosrc}></video>
            <VStack w={'full'} alignItems={'flex-start'} py={'4'} px={'4'} overflow={'auto'}>
                <Heading>Sample Video 1</Heading>
                <Text>This is the sample text for the above video...</Text>
            </VStack>

        </VStack>
        <VStack w={['full','xl']} alignItems={'stretch'} py={"8"} px={'6'}>
